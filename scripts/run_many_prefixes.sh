#!/bin/bash
# Many-prefixes (prefix-capacity) test at M=64. 4 cells.
# Phase 1 = 10 cold prefills; Phase 2 = same 10 prompts, warm (cache hits if
# KV/pool can hold all 20 prefix blocks).
set -u
SEED=1
...
# Phase 1 = cold pass: 10 prompts, --num-warmups 0.
# Phase 2 = warm pass: same 10 prompts, --num-warmups 0 (preserve pool state).
run_phase() {
...
echo "=== Many-prefixes test at M=64 ==="
echo "  Round 1: static C=20 (GPU0) + static C=40 (GPU1) ==="
run_cell manyprefix_static_C20 0 8000 static 20 44 &
run_cell manyprefix_static_C40 1 8001 static 40 24 &
wait
echo "  Round 2: static C=60 (GPU0) + unified pool=64 (GPU1) ==="
run_cell manyprefix_static_C60 0 8000 static 60 4 &
run_cell manyprefix_unified_init40 1 8001 unified 40 64 &
wait
echo "=== Many-prefixes test done ==="
